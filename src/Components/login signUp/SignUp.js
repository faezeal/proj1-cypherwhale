            ...
            {formik => (
                <div className='row d-flex bg-login mt-5 pt-5'>
                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                        <h3 className=' w-50 text-primary fs-1 position-absolute title d-flex justify-content-center register-title'>ثبت نام</h3>
                        ...
                        <Form className='form-content d-flex flex-column'>
                            ...
                            <button className='btn btn-primary mt-3 p-2'>ثبت نام</button>
                        </Form>
                        <span className='link-login d-flex justify-content-center'>قبلا ثبت نام کردم</span>
                    ...
                    <div className='col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6 d-flex justify-content-center align-items-center'>
                        <img src={`${process.env.PUBLIC_URL + '/assets/img/22.webp'}`} className="w-75 h-75 img"/>
                    </div>
                </div>     
            )}
        </Formik>
